...
def claude_ga_soru(buyruq):
    ...
    data = json.dumps({
        ...
        "messages": [{
            "role": "user",
            "content": "Sen Revit AI assistantisan. Faqat sof JSON formatda javob ber, ``` ishlatma. MUHIM: agar foydalanuvchi 'hisobot', 'spetsifikatsiya', 'hajm', 'hisob', 'chiqar' desa - faqat {\"amal\": \"hisobot\"} deb javob ber. Boshqa hollarda karkas format: {\"amal\": \"karkas\", \"eni\": 18, \"uzunligi\": 24, \"qadam\": 6, \"qavatlar\": 3, \"qavat_balandligi\": 3, \"kolonna_olcham\": \"400x400\", \"balka_olcham\": \"400x400\", \"plita\": \"monolit\", \"plita_qalinligi\": 200, \"material\": \"beton\"}. Eni, uzunligi, qadam, qavat_balandligi metrda. Olchamlar mm da. Plita: monolit yoki pk, kerak bolmasa \"\". Agar aytilmasa: qadam 0, qavatlar 1, qavat_balandligi 3, olchamlar \"\", plita \"\", plita_qalinligi 200, material \"\". Buyruq: " + buyruq
        }]
    })
...
buyruq = forms.ask_for_string(prompt="Buyruq bering:", title="Revit AI")

if buyruq:
    javob = claude_ga_soru(buyruq)
